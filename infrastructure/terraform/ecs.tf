...
# IAM Policy for accessing secrets and logs
  ...
  container_definitions = jsonencode([
    {
      ...
      image = var.app_image # e.g., "your-account.dkr.ecr.region.amazonaws.com/btg-pactual:latest"
      ...
      secrets = [
        {
          name      = "MONGODB_URL"
          valueFrom = aws_secretsmanager_secret.docdb_credentials.arn
        }
      ]
